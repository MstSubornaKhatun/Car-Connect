...
{/*  */}
<div className='flex max-sm:flex-col items-start sm:items-center gap-6'> <button className="cursor-pointer">Dashboard</button>
<button onClick={()=> navigate('/owner')} className="cursor-pointer px-8 py-2 bg-primary
